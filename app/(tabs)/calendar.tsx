...
const schoolCalendarData = {
  ...
  terms: {
    grades1to9: [
      { name: '1 триместр', period: '01.09.2025 – 30.11.2025', weeks: '11 недель' },
      { name: '2 триместр', period: '01.12.2025 – 28.02.2026', weeks: '11 недель' },
      { name: '3 триместр', period: '01.03.2026 – 31.05.2026', weeks: '12 недель (в 1 кл. до 22.05, 11 недель)' }
    ],
    grades10to11: [
      { name: '1 семестр', period: '01.09.2025 – 31.12.2025', weeks: '15 недель' },
      { name: '2 семестр', period: '12.01.2026 – 31.05.2026', weeks: '19 недель' }
    ]
  },
  holidays: [
    { name: 'Осенние каникулы', period: '07.10–12.10.2025', days: '6 дней' },
    { name: 'Осенние каникулы', period: '18.11–24.11.2025', days: '6 дней' },
    { name: 'Зимние каникулы', period: '31.12.2025 – 11.01.2026', days: '12 дней' },
  ...
  schedule: {
    ...
    shifts: {
      shift1: {
        start: '08:30',
        classes: ['1-е', '2а,2б,2г', '3а,3б', '4а,4б,4в', '5-е', '6а,6б', '7а,7б', '8а,8б', '9-е', '10-е', '11-е']
      },
      shift2: {
        start: '13:05',
    ...
    lessonDuration: {
      grade1FirstHalf: '35 мин (сентябрь-октябрь: 3 урока, ноябрь-декабрь: 4 урока)',
  ...
  assessment: [
    ...
    { grades: '1–4 классы', type: 'метапредметные', period: '06.04–11.04.2026' },
    { grades: '4 классы', type: 'личностные', period: '18.05–22.05.2026' },
    { grades: '5–6 классы', type: 'метапредметные', period: '01.04–07.04.2026' },
    { grades: '7 классы', type: 'метапредметные', period: '06.03–13.03.2026' },
    { grades: '8–9 классы', type: 'метапредметные', period: '26.01–30.01.2026' },
    { grades: '10 классы', type: 'метапредметные', period: '20.03–27.03.2026' },
    { grades: '5–8, 10 кл.', type: 'промежуточная аттестация', period: '01.04–30.05.2026' },
    { grades: '9, 11 классы', type: 'итоговая аттестация', period: 'по срокам Минпросвещения РФ' }
  ]
};
      ...
      >
          ...
          {daysUntilHoliday !== null ? (
            <>
              <ThemedText type="title" style={styles.counterNumber}>
                {daysUntilHoliday} {daysUntilHoliday === 1 ? 'день' : daysUntilHoliday < 5 ? 'дня' : 'дней'}
              </ThemedText>
        ...
        <ThemedView style={styles.section}>
          ...
          <ThemedView style={styles.infoCard}>
            <ThemedText style={styles.infoText}>
              <ThemedText type="defaultSemiBold">Начало:</ThemedText> 01.09.2025
            </ThemedText>
            <ThemedText style={styles.infoText}>
              <ThemedText type="defaultSemiBold">Продолжительность:</ThemedText>
            </ThemedText>
            <ThemedText style={styles.infoSubText}>• 1 классы – 33 недели</ThemedText>
            <ThemedText style={styles.infoSubText}>• 2–11 классы – 34 недели</ThemedText>
          </ThemedView>
        </ThemedView>
        ...
        <ThemedView style={styles.section}>
          ...
          <ThemedView style={styles.infoCard}>
            ...
            <ThemedText type="defaultSemiBold" style={[styles.termTitle, { marginTop: 16 }]}>
        ...
        <ThemedView style={styles.section}>
          ...
          <ThemedView style={styles.infoCard}>
            <ThemedText style={styles.infoText}>
              <ThemedText type="defaultSemiBold">Учебная неделя:</ThemedText> {schoolCalendarData.schedule.workWeek}
            </ThemedText>
            ...
            <ThemedView style={styles.shiftItem}>
              <ThemedText type="defaultSemiBold" style={styles.shiftTitle}>
                1 смена (начало {schoolCalendarData.schedule.shifts.shift1.start}):
              </ThemedText>
            ...
            <ThemedView style={styles.shiftItem}>
              <ThemedText type="defaultSemiBold" style={styles.shiftTitle}>
                2 смена (начало {schoolCalendarData.schedule.shifts.shift2.start}):
              </ThemedText>
              <ThemedText style={styles.shiftClasses}>
        ...
        <ThemedView style={styles.section}>
          ...
          <ThemedView style={styles.infoCard}>
            <ThemedText style={styles.infoText}>
              • 1-е классы (1 полугодие) – {schoolCalendarData.schedule.lessonDuration.grade1FirstHalf}
            </ThemedText>
            <ThemedText style={styles.infoText}>
              • 1-е классы (с января) – {schoolCalendarData.schedule.lessonDuration.grade1SecondHalf}
            </ThemedText>
            <ThemedText style={styles.infoText}>
              • 2–11 классы – {schoolCalendarData.schedule.lessonDuration.grades2to11}
            </ThemedText>
          </ThemedView>
        </ThemedView>
        ...
        <ThemedView style={styles.section}>
          ...
          <ThemedView style={styles.infoCard}>
            ...
            {schoolCalendarData.schedule.timetable.shift1.map((lesson, index) => (
            ...
            {schoolCalendarData.schedule.timetable.shift2.map((lesson, index) => (
              <ThemedText key={index} style={styles.timetableItem}>
                {lesson}
              </ThemedText>
            ))}
          ...
          <ThemedView style={styles.holidaysList}>
            {schoolCalendarData.assessment.map((assessment, index) => (
              <ThemedView key={index} style={styles.assessmentCard}>
                <ThemedText type="defaultSemiBold" style={styles.assessmentGrades}>
                  {assessment.grades}
                </ThemedText>
